...
'use strict';
    ...
    app.use('/api/v1/webhooks/mailing/bounced', upload.any(), mailerMid.mailgunValidationMiddleware);
    app.use('/api/v1/webhooks/mailing/dropped', upload.any(), mailerMid.mailgunValidationMiddleware);

    //Body-parser on the rest
    app.use(bodyParser.urlencoded({ extended: false }));
    app.use(bodyParser.json());

    app.use('/api/v1/webhooks/mailing/opened',  mailerMid.mailgunValidationMiddleware);
    app.use('/api/v1/webhooks/mailing/delivered',  mailerMid.mailgunValidationMiddleware);
