    ...
    module.exports.authenticate = function (req, res) {
        ...
        User.findOne( {'credentials.username': req.body.username})
            ...
            .then(function(skills){
                ...
                if (_loggedUser.student.character.skills.length > 0) return Promise.resolve(_loggedUser);
            ...
            .then( function(loggedUser) {
                ...
                return new Promise(function (resolve, reject){
                    ...
                    if (_.isNil(loggedUser.student.house)) {
                        customerController.getNextSortedHouse(loggedUser.customer)
                        .then(function(house){
                            _loggedUser.student.house = house._id;
                            return _loggedUser.save();
                        })
                    ...
                    else return resolve(loggedUser);
            ...
            .then( function(loggedUser) {
                ...
                fs.writeFile("tokenTest.txt", token, function(err) {
                    console.log(err);
                });
