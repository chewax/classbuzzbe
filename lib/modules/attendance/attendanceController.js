(function () {
    ...
    var createNewAttendance = function(_attData, doSave){
        ...
        return groupModel.findOne({_id:_attData._id})
            .then(function(group){
    ...
    module.exports.find = {
        ...
        one: function(req, res){
            attModel.find({_id: req.params._id})
                .populate('group')
                .populate('students._id', 'firstName lastName avatarURL student.character')
                .then( function (result) { res.status(200).json(result) })
                .catch( function (err) { errorHandler.handleError(err, req, res) });
        ...
        byGroup: function (req, res){
            attModel.find({group: req.body._id})
                .populate('group')
        ...
        byGroupByDate: function (req, res) {
            ...
            attModel.findOne({group: req.body._id})
                ...
                .then( function (result) {
                    ...
                    if(_.isNull(result)){
                        return createNewAttendance(req.body, false);
                    }
