(function () {
     ...
     * @returns {Promise}
     */
    var createEvent = function(userId, type, dsc, xpAward, achievementId, giverId) {

        if (_.isUndefined(achievementId)) achievementId = null;
        ...
        return userModel.findOne({_id: userId})
            ...
            .then (function (newEvent) {
                newEvent.populate("house achievement", function(err) {
    ...
    module.exports.find = {
        ...
        byCustomer: function(req, res) {
            eventModel.find({customer: req.body.customer})
                .sort("-timestamp")
                .populate("house")
                ...
                .then( function (events){
                    ...
                    else
                    {
                        filteredResult = events.filter(function(e){
                            return e.achievement.type == req.body.type;
                        })
                    }
