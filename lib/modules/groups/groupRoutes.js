(function(){
    ...
    module.exports.appendProtectedRoutes = function(router){
        ...
        router.post('/groups/:id/complement', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher"]), groupController.find.studentsComplement);

        router.delete('/groups', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher"]), groupController.remove);
        router.delete('/groups/:id/student', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher"]), groupController.removeStudentFromGroup);
