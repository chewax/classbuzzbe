                ...
                mailer.sendMail(data)
                    .then(function(mData){
                        ...
                        var recepientInfo = {
                            ...
                            branch: _st.branch._id || _st.branch
                        };
        ...
        return new Promise(function(resolve, reject){
            newProcessRecord(_customer, _branch, _teacher, _group, procDetail)
                .then(function(proc){
                    ...
                    if (typeof _group == 'object') return Promise.resolve(_group);
                    else return groupModel.findOne({_id:_group}).populate('students');

                })
                .then(function(popGroup){

                    popGroup.students.forEach(function(st){
                        _promises.push (
