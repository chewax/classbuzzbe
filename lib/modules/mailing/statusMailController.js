(function () {
    ...
    function createStudentStatusMail(st, _procId, sendMail, fromDate, toDate){
        ...
        var _st = st;
        var _teacher_msg_html, _attendance_html, _activities_html, _final_html, _specialEvents_html;
        ...
        return renderTeacherMessagesHTML(_st, fromDate, toDate)
            ...
            .then(function(html){
                ...
                return renderFinalHTML(_st, _teacher_msg_html, _activities_html, _attendance_html, _specialEvents_html);
            })
    ...
    function renderTeacherMessagesHTML(_st, fromDate, toDate){
        ...
        return new Promise(function(resolve, reject){
            ...
            andFilters.push({origin: 'statusMail'});
            
            if (fromDate != null && toDate != null) {
                andFilters.push({dateQueued: {$lte: toDate} });
                andFilters.push({dateQueued: {$gte: fromDate} });
                andFilters.push({status: 'sent'});
            }
            else {
                andFilters.push({status: 'ready'});
            }
        ...
        return new Promise(function(resolve, reject){
            ...
            if (weekactivities.length > 0) {
                ...
                weekactivities.forEach(function(a){
                    ...
                    var localLocale = moment(a.activity.timestamp);
                    localLocale.locale('es');
     ...
     * @returns {*}
     */
    function renderFinalHTML(_st, _mails_html, _activities_html, _attendance_html, _specialEvents_html){
