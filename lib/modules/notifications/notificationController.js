(function () {
    ...
    eh.on('incomingbirthday', function(user, birthdayUser) {
        ...
        newNotification.user = birthdayUser._id;
        newNotification.title = "Incoming Birthday";
        newNotification.message = "Hey, your birthday is near!! We want to celebrate by giving you a gold and xp boost for the next 10 days!! Make shure you make the most out of them"
        newNotification.type = "incomingBirthday";
        newNotification.detail = {
            user: birthdayUser
        };
