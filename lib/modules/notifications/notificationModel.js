(function () {
    ...
    var notificationSchema = new mongoose.Schema({
            ...
            type: {
                type:String,
                enum:[  "newQuest", "questCompleted", "achievementUnlocked", "activityCompleted", "skillLevelUp", "newMessage",
                        "goalFulfilled", "newTrait", "incomingBirthday", "incomingSpecialEvent", "statusMailOpened", "chestEarned" ],
            ...
            detail: {
                ...
                statusMail: {type: mongoose.Schema.Types.ObjectId, ref: 'StatusMail', default: null},
                msg: {type: mongoose.Schema.Types.ObjectId, ref: 'Message', default: null}
            },
