(function(){
    ...
    function getReportData (filters) {
        switch (filters.name) {
            ...
            case "all_attendance_year":
                return allAttenanceYearlyReport(filters);
                break;    

            case "all_activities":
                return allActivitiesReport(filters);
                break;
        }
    }

    function allAttenanceYearlyReport (filters) {
        ...
        return new Promise (function(resolve, reject){
            ...
            var targetMoment = moment().year(targetYear);
            ...
            roleModel.findOne({name:'student'})
                ...
                .then(function(sts) {
                    ...
                    _data.meta = {
                        ...
                        reportTitle: "Yearly Attendance",
                        reportDescription: "(" + targetMoment.format('YYYY') + ")"
                    };

                    var from = targetMoment.clone().startOf('year');
                    var to = targetMoment.clone().endOf('year');
    ...
    function allActivitiesReport (filters) {
        ...
        return new Promise(function(resolve, reject) {
            activityModel.find({customer: filters.customer})
                .sort({'reward.xp': -1})
                .populate('customer')
                .then(function(result){
                _data.meta = {
                    customerLogo: result[0].customer.logoURL,
                    reportTitle: "All activities report",
                    reportDescription: "All activities (penalties/rewards)"
                };
