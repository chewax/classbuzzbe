(function(){
    ...
    function Session (userId, socketId, type) {
        ...
        this.owner = userId;
        this.type = type;
        this.connected = [{user: userId, socket: socketId, connectedAt: moment(), status:'not-ready'}];
    ...
    Session.prototype.join = function(userId, socketId) {
        ...
        if (uIdx == -1) {
            ...
            this.connected.push({ user: userId, socket: socketId, connectedAt: moment(), status:'not-ready'});
            return true;
        }
