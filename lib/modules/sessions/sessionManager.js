(function(){
    ...
    function joinSession (_id, userId, socketId) {
        var uIdx = _.findIndex(usersInSessions, userId);
    ...
    function leaveSession (_id, userId) {
        ...
        if (sIdx == -1) return; //No active session to leave from...probably owner left before this user and thus it has been destroyed...
