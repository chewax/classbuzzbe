(function(){
    ...
    function leaveSession (_id, userId) {
        ...
        if (activeSessions[sIdx].owner.toString() == userId.toString()) {
            ...
            //But before pull every user from userInSessions.
            activeSessions[sIdx].connected.forEach(function(c){
                _.pull(usersInSessions, c.user._id.toString());
            })
