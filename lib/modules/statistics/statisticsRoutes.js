(function(){
    ...
    module.exports.appendProtectedRoutes = function(router){
        ...
        router.get('/statistics/teacher/:id/history', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher"]), statController.teacher.api.activitiesHistory);
        router.get('/statistics/teacher/:id/yearly', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher"]), statController.teacher.api.activitiesYearly);
        ...
        router.get('/statistics/student/:id/stats', allow(["branch-admin", "customer-admin", "sub-branch-admin", "teacher", "parent", "student"]), statController.student.api.activityStats);
