(function () {
    ...
    var Customer = require('../customers/customerModel');
    ...
    module.exports.find = {
        ...
        exists: function(req, res){
            ...
            if (typeof req.params.username != 'undefined') query = {'credentials.username':req.params.username};
        ...
        publicProfile: function (req, res) {
            User.findOne( {_id: req.params.id}, '-__v -activity -credentials.password')
        ...
        paginate: function (req, res) {
            ...
            if (andFilters.length > 0) {
                ...
                var pagOptions = {
                    ...
                    populate: 'roles groups student.house groupsOwned',
                    lean: true
                };
    ...
    module.exports.quests = {
         ...
         */
        all: function(req, res){
            if (typeof req.query.completed != "undefined" && req.query.completed) {
                User.findOne({_id: req.params.id})
                .sort("-assigned")
                .populate('student.character.quests.quest')
                .deepPopulate('student.character.quests.goals.goal.skill')
                .then( function (user){
                    res.status(200).json(user.student.character.completedQuests);
                })
                .catch(function (err) { errorHandler.handleError(err, req, res) })    
            }
            else {
    ...
    module.exports.parent = {
        ...
        new: function (req, res) {
            ...
            User.find({$or: [{'student.parents.doc': parent_user_doc}, {'student.parents.doc': parent_user_doc}]})
                .select('_id customer branches')
                .then(function(result){
                ...
                .then(function (hash) {
                    ...
                    var newUser = new User(req.body);
                    newUser.roles = [];
                    newUser.customer = _kidsCustomer[0].customer;
                    newUser.branches = _kidsCustomer[0].branches;
                    return newUser.addRole('parent');
                })
                .then(function (result) { res.status(200).json(result) })
                .catch(function (err) { errorHandler.handleError(err, req, res) });
        ...
        findParents:function(req, res) {
            if (req.query.dni) {
                User.findOne({'student.parents.doc': req.query.dni})
                    .then(function(result){ res.status(200).json(result);})
                    .catch(function(err){errorHandler.handleError(err, req, res);})
            }
        },
        ...
        findChildren: function(req, res){
            ...
            if (req.query.dni) {
                var parent_user_doc = req.query.dni;
                User.find({'student.parents.doc': parent_user_doc})
                    .select('-credentials')
                ...
                User.findOne({_id: req.params.id})
                    .then(function(parent){
                        return User.find({'student.parents.doc': parent.doc})
                                .select('-credentials') 
                    })
                    .then(function(children){ res.status(200).json(children); })
                    .catch(function(err){errorHandler.handleError(err, req, res);})
            }
    ...
    module.exports.lookForNewQuests = function(userId){
        ...
        console.log("Looking for new quests: ", userId);
            ...
            .then( function (user) {
                ...
                Quest.find({customer: user.customer})
                    ...
                    .then(function(quests){
                        ...
                        var userQuests = _user.student.character.quests.forEach(function(q){
                        ...
                        if (assignableQuests.length == 0) assignableQuests = questIdList; //When there is no new quest to assign, assign a random old one.
                        ...
                        _user.addQuest(newQuest)
                            .then(function(_user){
                                console.log("New quest...emitting");
    ...
    module.exports.settings = {
        update: function(req, res) {
            ...
            User.update({_id: req.params.id}, { 
                $set: { 
                    'settings.lang.code': req.body.lang.code, 
                    'settings.lang.dsc': req.body.lang.dsc, 
    ...
    module.exports.adHocParentUpdateMailingProcess = function(req, res) {
        res.status(200).send("Newsletter process started!");
        var _studentRole = {};
        var args = [req.query.fromDate, req.query.toDate]
        if (typeof req.query.customerId != undefined && req.query.customerId != null) args.push(req.query.customerId);
        utils.runScript(__dirname+'/../core/batch/statusMail_adHoc_batch.js', args , function (err) {
            if (err) throw err;
    ...
    module.exports.studentSpecificParentNewsletter = function(req, res){
        ...
        User.findOne({_id:req.body.id})
            .populate('customer branch student.character.activities.activity student.character.skills.skill')
            .then(function(st){
