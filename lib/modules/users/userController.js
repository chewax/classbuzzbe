(function () {
    ...
    module.exports.adHocParentUpdateMailingProcess = function(req, res) {
        ...
        .then(function(branches){
            ...
            branches.forEach(function(b){
                ...
                .then(function(proc){
                    _proc = proc;
                    return User.find({$and:[{roles:_studentRole._id}, {customer: b.customer}]}).populate('customer branches student.character.activities.activity student.character.skills.skill');
                })
                .then(function(students){
    ...
    module.exports.studentSpecificParentNewsletter = function(req, res){
        ...
        User.findOne({_id:req.body.id})
            .populate('customer branches student.character.activities.activity student.character.skills.skill')
            .then(function(st){
