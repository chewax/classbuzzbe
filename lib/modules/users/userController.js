(function () {
    ...
    module.exports.checkForIncomingBirthdays = function(){
        ...
        console.log('[classbuzz] Starting birthday process..'.cyan);
        ...
        Role.findOne({name: 'student'})
            ...
            .then (function(studentUsers){
                studentUsers.forEach(function(s){
                    ...
                    var birthDate = new Date(s.birthday).getDate();
                    var birthMonth = new Date(s.birthday).getMonth();

                    if (birthMonth == todaysMonth) {
                        if (birthDate == (todaysDate + 2)) { //Incoming Birthday in 2 days

                            //Find teachers and emit birthday notification.
                            User.findStudentTeachers(s.doc)
                                .then(function(teachers){
