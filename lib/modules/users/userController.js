        ...
        add: function (req, res) {
            ...
            User.findOne( {_id: req.params.id} )
                ...
                .then(function(activity) {
                    ...
                    _user.applyReward(_activity.reward);
                    ...
                    return houseController.getXPAward(_user.customer, _user.student.house, _activity.reward.xp)
                })
            ...
            .then(function(_user){
                ...
                _user.student.character.activeQuests.forEach(function(q){
                    ...
                    if (q.isCompleted)  {
                        ...
                        //house controller would query db for that info. Adding overload and elevating the risk of getting
                        //different information each time.
                        houseController.getXPAward(_user.customer, _user.student.house, q.quest.reward.xp)
                            .then(function(houseXp){
