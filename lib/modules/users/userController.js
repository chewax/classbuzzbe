(function () {
    ...
    module.exports.adHocParentUpdateMailingProcess = function(req, res) {
        ...
        .then(function(role){
            _studentRole = role;
            if (req.query.customerId) return Branch.find({customer: req.query.customerId});
            ...
            branches.forEach(function(b){
                ...
                .then(function(students){
                    students.forEach(function(st){
                        statusMailsController.createStudentStatusMail(st, _proc._id, true, new Date(req.query.fromDate), new Date(req.query.toDate) );
                    })
                })
            })
        })
