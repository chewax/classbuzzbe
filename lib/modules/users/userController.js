    ...
    module.exports.character = {
        ...
        get: function (req, res) {
            ...
            User.findOne( {_id: req.params.id})
                ...
                .catch(function (err) { console.log("========"); console.log(err); errorHandler.handleError(err, req, res) });
        },
    ...
    module.exports.parent = {
        ...
        new: function (req, res) {
            ...
            User.find({$or: [{'student.parents.doc': parent_user_doc}, {'student.parents.doc': parent_user_doc}]})
                ...
                .then(function (result) { console.log(result); res.status(200).json(result) })
                .catch(function (err) { console.log(err); errorHandler.handleError(err, req, res) });
