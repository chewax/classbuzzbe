        ...
        return new Promise(function(resolve, reject){
            specialEventsModel.findOne({_id: eventId})
                ...
                .then(function(_event){
                    ...
                    // To know the minimum required grade we should access the specialEvent property approves with.
                    ...
                    chestAward.chest = eligibleChests[Math.floor(Math.random() * eligibleChests.length)];
        ...
        return new Promise ( function(resolve, reject) {
            chestModel.findOne({_id:characterChest.chest})
                ...
                .then(function(chest){
                    ...
                    // Add droped items to inventory
                    _user.student.character.inventory = _user.student.character.inventory.concat(droppedItems);
