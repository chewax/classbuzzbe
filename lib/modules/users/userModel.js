(function () {
    ...
    userCharacter.virtual('lastQuestAssignment').get(function(){
        var sortedQuests = _.sortBy(this.quests, function(q) { return a.timestamp }).reverse();
        return sortedQuests[0].timestamp;
    });
    ...
    var options = {
        populate: {
            ...
            'student.quests.trigger.activity': {select: 'avatarURL name'}
        }
    };
