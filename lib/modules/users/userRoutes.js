(function(){
    ...
    module.exports.appendProtectedRoutes = function(router){
        ...
        router.get('/users/:id/specialEvents', allow(["branch-admin", "customer-admin", "teacher"]), userController.student.findSpecialEvents);
        router.get('/users/:id/specialEvents/completed', allow(["branch-admin", "customer-admin", "teacher"]), userController.student.findCompletedSpecialEvents);
