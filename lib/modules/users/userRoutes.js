(function(){
    ...
    module.exports.appendProtectedRoutes = function(router){
        ...
        router.delete('/users/:id/quest', allow(["customer-admin", "branch-admin"]), userController.quests.remove);
        ...
        router.post('/users/:id/branches/update', allow(["customer-admin", "branch-admin"]), utils.deprecated); //Use update user
