...
describe("Socket IO Play Session Server",function(){
    ...
    it('Should broadcast session.unable.start if start is attempted before everyone is ready.', function(done){
        ...
        client1.on('connect', function(data){
            ...
            client1.on('session.unable.start', function(_session, reason){
                reason.code.should.equal(300);
                client1.disconnect();
                done();
            });
    ...
    it('Should broadcast to all clients the game countdown', function(done){
        ...
        client1.on('connect', function(data) {
            ...
            client1.on( 'session.countdown.tick', function ( _session, count ) {
                countdown = count;
                countup += 1;
            });
